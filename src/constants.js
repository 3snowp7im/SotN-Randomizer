  ...
  const startRoomData = [                                                       // Data provided for starting room randomizer (Writes are used, other fields are reference)
    {
      ...
      id: 58,
      comment: "Anti-Chapel (Reverse Goggles)",
      stage: 0x26,
      room: 8,
      xPos: 196,
      yPos: 128,
      ...
      id: 59,
      comment: "Anti-Chapel (Confessional)",
      stage: 0x26,
      room: 7,
      xPos: 204,
      yPos: 128,
      ...
      id: 66,
      comment: "Reverce Caverns (Force of Echo)",
      stage: 0x29,
      room: 12,
      xPos: 32,
      yPos: 128,
      ...
      id: 67,
      comment: "Reverce Caverns (Alucard Shield)",
      stage: 0x29,
      room: 21,
      xPos: 32,
      yPos: 128,
      ...
      id: 74,
      comment: "Necromancy Laboratory (Godess Shield)",
      stage: 0x2c,
      room: 6,
      xPos: 248,
      yPos: 128,
