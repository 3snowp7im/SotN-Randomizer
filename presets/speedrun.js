(function(self) {
  ...
  builder.lockLocation(RELIC.SPIKE_BREAKER, [
    ...
    RELIC.JEWEL_OF_OPEN + RELIC.SOUL_OF_WOLF + RELIC.POWER_OF_WOLF
      + RELIC.GRAVITY_BOOTS + RELIC.SPIKE_BREAKER,
  ])
