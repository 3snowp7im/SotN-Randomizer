(function(self) {
  ...
  // Twilight Cloak requires Holy Glasses + Mist + flight.
  builder.lockLocation(LOCATION.TWILIGHT_CLOAK, [
    RELIC.HOLY_GLASSES + RELIC.FORM_OF_MIST + RELIC.SOUL_OF_BAT,
    RELIC.HOLY_GLASSES + RELIC.FORM_OF_MIST + RELIC.LEAP_STONE
      + RELIC.GRAVITY_BOOTS,
    RELIC.HOLY_GLASSES + RELIC.FORM_OF_MIST + RELIC.POWER_OF_MIST,
  ])
  ...
  // Shotel requires Holy Glasses + Mist + flight.
  ...
  // Staurolite requires Holy Glasses + Mist + flight.
