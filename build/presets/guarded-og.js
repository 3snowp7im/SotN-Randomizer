...
(function(self) {
  ...
  const builder = PresetBuilder.fromJSON({"metadata":{"id":"guarded-og","name":"Guarded O.G.","description":"The best preset for trying out the SOTN Randomizer. Utilizes our 'guarded' relic locations but Gold ring, Silver ring, Holy glasses and Spike Breaker are in vanilla locations.","author":["TalicZealot"],"weight":250,"knowledgeCheck":"None","extension":"Guarded","complexity":1,"itemStats":"Normal","timeFrame":"Fast","moddedLevel":"None","castleType":"Normal","transformEarly":"No","transformFocus":"None","winCondition":"Normal"},"inherits":"casual","preventLeaks":false,"stats":false,"music":false,"placeRelic":[{"location":"Silver ring","relic":"Silver ring"},{"location":"Gold ring","relic":"Gold ring"},{"location":"Holy glasses","relic":"Holy glasses"},{"location":"Spike Breaker","relic":"Spike Breaker"}]})
